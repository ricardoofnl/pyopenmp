...
_fn = _capi.lazy("Object_GetMovingTargetRot", ctypes.c_bool, [ctypes.c_void_p, ctypes.POINTER(ctypes.c_float), ctypes.POINTER(ctypes.c_float), ctypes.POINTER(ctypes.c_float)])


def object_get_moving_target_rot(object):
